...
struct LFMSettings
{
    ...
    static constexpr double mf_min = 0;
    static constexpr double mf_max = 10000;
    double mf = 0;

    static constexpr double cf_min = 0;
    static constexpr double cf_max = 10000;
    double cf = 0;

    static constexpr double df_min = 0;
    static constexpr double df_max = 10000;
    double df = 0;

    static constexpr double dt_min = 0;
    static constexpr double dt_max = 10000;
    double dt = 0;
};
...
private:
    ...
    // line edits
    QLineEdit mf_line_edit = QLineEdit("0,0");
    QLineEdit cf_line_edit = QLineEdit("0,0");
    QLineEdit df_line_edit = QLineEdit("0,0");
    QLineEdit dt_line_edit = QLineEdit("0,0");
